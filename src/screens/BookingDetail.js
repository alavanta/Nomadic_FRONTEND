...
import { Animated, Image, ScrollView, Dimensions, FlatList, TouchableOpacity, StyleSheet, Text, View, AsyncStorage, ActivityIndicator } from 'react-native';
            ...
            <View style={styles.container}>
                <ScrollView
                    ...
                    <View style={styles.priceTag}>
                        ...
                        <Text style={styles.caption}>Joko Semar</Text>
                    </View>
                ...
                <View style={styles.footer}>
                    <TouchableOpacity
                        onPress={() => this.props.navigation.navigate('PrivateChat')}
                        style={styles.button}
                    >
...
export default withNavigation(BookingDetail);
