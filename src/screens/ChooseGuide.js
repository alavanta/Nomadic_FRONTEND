            ...
            data: [
                {
                    ...
                    guide_photo: 'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/musician-shawn-mendes-performs-on-nbcs-today-at-rockefeller-news-photo-965176864-1563915069.jpg',
                    guide_abilities: 'bisa segalanya, bisa bahasa semutjbja jhgjgchfddrg vgvghghjjkh hvhvjjkhjkhjkn bmnbnb hvjhvjhvjkhvjkh sdkdb  wsbdjkwa,sbfjsabfjasbkjcbaws,kdnsam, jjhasbjkbjbjkb;jkvafs',
                    guide_gender: 'M',
                    guide_age: 18
                },
                {
            ...
            <View style={styles.card}>
                <View style={{ flex: 1, width: '100%' }}>
                    <View style={{ alignItems: 'center', alignSelf: 'center', width: '100%' }}>
                        ...
                        <Text style={styles.name} numberOfLines={1}> {item.guide_name} </Text>
                    </View>
                    <View style={{ margin: 5, marginTop: 10 }}>
                        <Text style={styles.biodata} numberOfLines={1}>Age : {item.guide_age} </Text>
                        <Text style={styles.biodata} numberOfLines={1}>Gender : {item.guide_gender == 'M' ? 'Male' : item.guide_gender == 'F' ? 'Female' : 'Unknow'} </Text>
                    </View>
                    <View style={{ margin: 5 }}>
                        <Text style={styles.title}>Summary :</Text>
                        <Text style={styles.description} numberOfLines={6}> {item.guide_abilities} </Text>
                    </View>
                </View>
                <TouchableOpacity onPress={() => this.chooseHandler(item)} style={styles.choose}>
            ...
            <View style={styles.container}>
                <View style={{ flex: 3, justifyContent: 'center', backgroundColor: '#FAFAFA' }}>
                    <View style={styles.header}>
                        ...
                        <Text style={{ marginLeft: 20,fontSize: 20, color: '#666', fontWeight: '500' }}>Choose Your Tour Guide</Text>
                    </View>
                    <Carousel
