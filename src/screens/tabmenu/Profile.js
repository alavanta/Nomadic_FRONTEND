...
import { getUserById } from '../../public/redux/action/index';
...
class Profile extends Component {
  ...
  componentDidMount() {
    AsyncStorage.getItem('token').then(result => {
      this.props.dispatch(getUserById(result)).then(() => {
        console.log(this.props.data, 'dari mount');
        this.setState({
    ...
    return (
      <View style={{ flex: 1, backgroundColor: '#FFF' }}>
        <View style={styles.topContainer}>
          <View style={{ alignItems: 'center' }}>
            <Avatar
              size="large"
              rounded
              title={`${this.state.name[0]}${this.state.name[1]}`}
            />
        ...
        <View style={styles.bottomContainer}>
          ...
          <View style={styles.line} />
          <TouchableOpacity
            style={[styles.accountOption, { backgroundColor: '#EF4453' }]}
            ...
            >
              ...
              >
                <TouchableOpacity
                  ...
                  style={[
                    styles.btnModal,
                    { backgroundColor: '#62CA90', borderColor: '#62CA90' }
                  ]}
                >
                  <Text>Yes</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  ...
                  style={[
                    styles.btnModal,
                    { backgroundColor: '#E75E3F', borderColor: '#E75E3F' }
                  ]}
                >
                  <Text>No</Text>
                </TouchableOpacity>
